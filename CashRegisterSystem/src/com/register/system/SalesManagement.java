...
public class SalesManagement {
    ...
    private void initialize() {
        ...
        Ttotal.addActionListener((ActionEvent arg0) -> {
            Ttotal.getText();
        });
        Ttotal.setText("0.00");
        ...
        btnCash.addActionListener((ActionEvent arg0) -> {
        ...
        Tchange.addActionListener((ActionEvent arg0) -> {
            Tchange.getText();
        });
        ...
        lblreciept.addActionListener((ActionEvent arg0) -> {
            ...
            txtReciept.append("  *********************************************\n");
            txtReciept.append("  " + tDate.format(timer.getTime())
                    + "                                   "
                    + tTime.format(timer.getTime()) + "\n");
            txtReciept.append("  *********************************************\n");
            txtReciept.append("   Tax:"
                    + "                                               "
                    + overallTax.getText() + "\n");
            txtReciept.append("   SubTotal:"
                    + "                                      "
                    + subTotal.getText() + "\n");
            txtReciept.append("   Total:"
                    + "                                            $"
                    + Ttotal.getText() + "\n");
            txtReciept.append("   Cash:"
                    + "                                             $"
                    + Tcash.getText() + "\n");
            txtReciept.append("   Change:"
                    + "                                         "
                    + Tchange.getText() + "\n");
            txtReciept.append("  *********************************************\n");
